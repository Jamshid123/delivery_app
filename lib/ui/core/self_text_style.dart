...
class SelfTextStyle {
  ...
  static const TextStyle sendCodeRetryTextStyle = TextStyle(
      fontWeight: FontWeight.w600, fontSize: 16, color: SelfColors.black);
  static const TextStyle appBarHeadingTextStyle = TextStyle(
      fontWeight: FontWeight.w700, fontSize: 20, color: SelfColors.black);
  ...
  static const TextStyle languageTextStyle = TextStyle(
      ...
      fontSize: 14,
      color: SelfColors.blackSettingPageText);
  static const TextStyle textAppBarMenuTextStyle = TextStyle(
      fontWeight: FontWeight.w600,
      fontSize: 20,
      color: SelfColors.black,
      fontFamily: 'Mulish');
  static const TextStyle textFoodNameTextStyle = TextStyle(
    fontSize: 14,
    fontFamily: 'Mulish',
    fontWeight: FontWeight.w500,
    color: SelfColors.blackChooseLang,
  );
  static const TextStyle textFoodPriceTextStyle = TextStyle(
    fontFamily: 'Mulish',
    fontSize: 14,
    fontWeight: FontWeight.w600,
  );
  static const TextStyle textFoodTypeTextStyle = TextStyle(
    fontSize: 12,
    fontFamily: 'Mulish',
    fontWeight: FontWeight.w400,
  );
